            ...
            >
                <div className="max-w-5xl mx-auto md:mx-0 text-left">
                    ...
                    >
                        ...
                        Secretária Comercial de Elite 2.0
                    </motion.div>
                    ...
                    >
                        <span className="block">Sua secretária</span>
                        <span className="block mt-2">Pode estar te fazendo</span>
                    ...
                    >
                        Sem perceber, você pode estar perdendo pacientes todos os dias por falta de processos. Descubra como transformar o atendimento em uma força de vendas.
                    </motion.p>
